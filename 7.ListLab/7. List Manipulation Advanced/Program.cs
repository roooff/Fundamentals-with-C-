namespace _7._List_Manipulation_Advanced
{
    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            static bool CheckIfEquals(List<int> original, List<int> changed)
            {
            ...
            static void ContainsNumber(string[] command, List<int> integers)
            {
                int number = int.Parse(command[1]);
            ...
            static void PrintEven(List<int> integers)
            {
            ...
            static void PrintOdd(List<int> integers)
            {
                for (int i = 0; i < integers.Count; i++)
                {
                    if (integers[i] % 2 != 0)
            ...
            static void PrintSum(List<int> integers)
            {
                int sum = 0;
                for (int i = 0; i < integers.Count; i++)
                {
            ...
            static void Filter(string[] command, List<int> integers)
            {
